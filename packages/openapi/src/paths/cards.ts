...
registry.registerPath({
  ...
  description:
    ...
    'balance in millisatoshis (a high ceiling when that balance cannot be read); the ' +
    'callback does not impose a fixed sats cap. Send the request header `x-request-action: info` ' +
