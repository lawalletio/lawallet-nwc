---
title: "Month 2: CI/CD + Auth Flow Upgrade"
description: "Foundation phase: GitHub Actions CI/CD pipeline, security scanning, Vercel config, NIP-98 → JWT session auth migration."
---
