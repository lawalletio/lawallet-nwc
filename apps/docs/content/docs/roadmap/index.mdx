---
title: "Roadmap"
description: "6-month development timeline for LaWallet NWC, funded by OpenSats."
---
...
| 4 | Enhancement | Planned | **User Dashboard** (profile, npub/NIP-05, preferences), Courtesy NWC via [lncurl](https://github.com/rolznz/lncurl), wallet polish, white-label |
...
### Month 4: User Dashboard + Courtesy NWC (lncurl) + Wallet Polish

- **User Dashboard**: profile, npub/NIP-05 setup, address config, redirect management, NWC connection, preferences
- Courtesy NWC via [lncurl](https://github.com/rolznz/lncurl) integration (no custom proxy container needed)
...
See [Vision](../getting-started/vision) for the CRM + AI + Nostr communications roadmap (months 7+).
...
|-------|-----------|---------|
| 4 | External ([lncurl](https://github.com/rolznz/lncurl)) | Courtesy NWC wallets |
