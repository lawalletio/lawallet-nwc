...
1. **Card System Completion** — Android BoltCard login app, [`simple-card-manager`](https://github.com/lawalletio/simple-card-manager) rebrand, end-to-end issue → activate → pair → pay flow.
