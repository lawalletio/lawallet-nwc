...
1. **Card System Completion** — [`card-installer`](https://github.com/lawalletio/card-installer) (Android, NFC; bulk-writes blank NTAG424 cards and registers them as *initialized*), [`card-manager`](https://github.com/lawalletio/card-manager) (prints an Activation QR for any initialized card), end-to-end design → write → activate → pair → pay flow.
