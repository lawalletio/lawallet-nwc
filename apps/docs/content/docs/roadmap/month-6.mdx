---
title: "Month 6: NWC Proxy Lite + Lightning Compliance + Deployment"
description: "Expansion phase: NWC Proxy Lite settlement layer, full LUD-16/21/22 + NIP-57 closeout, deploy targets, security audit prep."
---
...
**Depends on:** Month 5 (Card System + Platform Polish + NWC Listener Lite)
