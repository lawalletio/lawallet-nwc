---
title: "Month 6: NWC Payment Listener + Card Activation + Deploy Targets + Backup & Restore"
description: "Expansion phase: NWC Payment Listener as a live transport service, SIMPLE/ONE_TIME card activation, deploy targets, Backup & Restore. Settlement/compliance deferred to Month 7."
---
...
- Complements the existing `integrations/WORDPRESS.md` guidance
