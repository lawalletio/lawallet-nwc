---
title: 'NWC & Routing'
description: 'Remote wallets, connection strings, and the four routing modes of a lightning address.'
---
...
```tsx
import { useAddress, useRemoteWallets } from '@lawallet-nwc/react'
