...
description: 'Issue reserved lightning addresses on behalf of your users, for instances where self-registration is closed.'
---
...
<Callout type="info" title="Complete example">
...
```typescript
import { toPubkey } from '@lawallet-nwc/sdk'
...
import { signChallengeEvent } from '@lawallet-nwc/sdk'
...
import { verifyChallengeEvent } from '@lawallet-nwc/sdk'
...
<Callout type="warn" title="Mint once per process">
...
`examples/admin-provisioning` shows this as a third screen: claim, then
