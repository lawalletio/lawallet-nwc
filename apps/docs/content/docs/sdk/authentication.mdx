...
description: "Nostr-signed requests: every API call is a NIP-98 event signed by the user's key."
---
...
```typescript
import { nsecSigner } from '@lawallet-nwc/sdk'
...
```typescript
import { browserSigner, hasBrowserExtension } from '@lawallet-nwc/sdk'
...
<Callout type="info" title="Extension prompts">
...
The SDK never persists anything. `@lawallet-nwc/react` optionally remembers a
...
<Callout type="warn" title="First-party session JWTs">
