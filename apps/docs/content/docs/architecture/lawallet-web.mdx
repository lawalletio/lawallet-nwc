...
- Optionally provision courtesy NWC wallets via LNCurl during user creation
...
- **LNCurl**: Optional courtesy-wallet provisioning during user creation when auto-create is enabled
