---
title: "Events Plugin"
description: "Community event management with QR/NFC check-in and automatic badge issuance."
---
...
3. Issue badge to attendee's pubkey (see [Badges](./badges))
