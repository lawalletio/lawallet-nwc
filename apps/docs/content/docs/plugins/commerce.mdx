...
description: "Merchant directory with badge-based loyalty discounts via Lightning."
---
...
| `tech` | Tech | Tech stores, repairs |
| `entertainment` | Entertainment | Gaming, events |
| `health` | Health | Health, wellness |
| `education` | Education | Courses, workshops |
| `travel` | Travel | Hotels, tourism |
