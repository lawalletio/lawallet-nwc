...
- Optional automatic LNCurl courtesy-wallet provisioning when auto-create is enabled
...
2. Call `GET /api/users/me` to load the user. If LNCurl auto-create is enabled, the server may provision a courtesy NWC wallet.
