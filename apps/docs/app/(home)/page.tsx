...
const toolbox = [
  ...
  },
  {
    ...
    description:
      'Self-host on Docker, Umbrel, or Start9 with one-command deployment',
    href: '/docs/deploy',
    icon: 'container',
    badge: 'DevOps',
    badgeColor: '#4DB6AC'
  },
  {
    ...
    description:
      'Build ticketing, commerce, and merchant tools on top of LaWallet',
    href: '/docs/plugins',
    icon: 'plug',
    badge: 'Plugin',
    badgeColor: '#9C27B0'
...
const deployOptions = [
  ...
  },
  {
    title: 'Local Deploy',
    description:
      'Run the TypeScript build on your own machine for development.',
  ...
  },
  {
    title: 'Docker',
    description:
      'Containerized deploy with docker compose for any VPS or server.',
