...
export function RegisterAddressFlow({
  ...
  // Touch /api/users/me first so the User row exists before /api/invoices
  // (which rejects with "User not found" for first-time pubkeys).
  ...
  useEffect(() => {
    ...
    apiClient.get('/api/users/me')
      .catch(() => null)
      .then(() => generateInvoice(initialUsername))
  }, [initialUsername, generateInvoice, apiClient])
