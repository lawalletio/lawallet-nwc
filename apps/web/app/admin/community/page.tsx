...
import { Camera, ExternalLink, Globe, ImageUp, Mail, Send } from 'lucide-react'
...
/**
 * X (Twitter) brand mark. Lucide dropped remaining brand icons in 1.44;
 * simple-icons path (CC0), same treatment as Discord above.
 */
              ...
              {links.map(({ key, label, icon: Icon, raw, href }) => (
                <li key={key}>
                  <a
                    href={href}
                    target={
                      href.startsWith('mailto:') || href.startsWith('nostr:')
                        ? undefined
                        : '_blank'
                    }
